...
<%@page import="com.liferay.portal.license.PortalLicenseException"%>
...
<liferay-ui:error exception="<%= PortalLicenseException.class %>" message="portal-instances-limited-by-license-please-contact-portal-provider-to-update-license" />
