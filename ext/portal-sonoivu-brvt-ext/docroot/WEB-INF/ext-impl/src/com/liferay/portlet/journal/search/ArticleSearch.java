 ...
 * @author HUNGDX
 * content: Bo cot Id trong danh sach webcontent hien thi
 */
		...
		try {
			...
			if (Validator.isNotNull(orderByCol) &&
				...
				orderByCol = preferences.getValue(
					PortletKeys.JOURNAL, "articles-order-by-col", "display-date");
				orderByType = preferences.getValue(
					PortletKeys.JOURNAL, "articles-order-by-type", "desc");
			}
