...
public class EditArticleAction extends PortletAction {
	...
	protected Object[] updateArticle(ActionRequest actionRequest)
		...
		/**
		 * Kiem tra xem co file anh mo ta kem theo bai viet hay ko?
		 */
		byte[] smallImageBytes = FileUtil.getBytes(smallFile);
		
		if(!smallImage){
			
			if(smallFile != null && smallImageBytes != null && smallImageBytes.length > 0){
