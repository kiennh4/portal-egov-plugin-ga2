...
public class PropsValues {
	...
	public static final boolean PORTAL_MEMCAHCED_ENABLE = GetterUtil.getBoolean(PropsUtil.get("portal.memcached.enable"));
	
	public static final long PORTAL_MEMCAHCED_LIFETIME = GetterUtil.getLong(PropsUtil.get("portal.memcached.LifeTime"));
	
	public static final String[] PORTAL_MEMCAHCED_HOST = StringUtil.split(PropsUtil.get("portal.memcached.host"),StringPool.COMMA);
	
	public static final String PORTAL_MEMCAHCED_WEIGHT = PropsUtil.get("portal.memcached.weight");
	
	public static final String PORTAL_MEMCAHCED_SOCKETTIMEOUT = PropsUtil.get("portal.memcached.SocketTimeOut");
	
	public static final String PORTAL_MEMCAHCED_SOCKETCONNECTTO = PropsUtil.get("portal.memcached.SocketConnectTo");
	
	public static final String PORTAL_MEMCAHCED_MAINTTHREADSLEEP = PropsUtil.get("portal.memcached.MaintThreadSleep");
	
	public static final String STATIC_CACHE_DIR = PropsUtil.get("static.cache.dir");
