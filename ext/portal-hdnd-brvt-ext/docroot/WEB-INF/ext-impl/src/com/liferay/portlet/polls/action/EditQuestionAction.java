...
public class EditQuestionAction extends PortletAction {
	...
	protected void updateQuestion(
		...
		serviceContext.setCommunityPermissions(new String[] {ActionKeys.VIEW});
		
		serviceContext.setGuestPermissions(new String[] {ActionKeys.ADD_VOTE});
		serviceContext.setGroupPermissions(new String[] {ActionKeys.ADD_VOTE});
		serviceContext.setCommunityPermissions(new String[] {ActionKeys.ADD_VOTE});
