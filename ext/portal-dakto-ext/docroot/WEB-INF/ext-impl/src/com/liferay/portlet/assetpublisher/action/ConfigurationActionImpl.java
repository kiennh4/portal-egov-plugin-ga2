 ...
 * @author HungDX Them phan cau hinh hien thi danh sach tin bai lien quan khi hien thi chi tiet 1 ban tin
 * 
 */
public class ConfigurationActionImpl extends DefaultConfigurationAction {
	...
	public void processAction(
		...
		if (cmd.equals(Constants.UPDATE)) {
			...
			//cap nhat cau hinh tin bai lien quan
			updateRelatedAssetSettings(actionRequest);
	...
	protected void updateDisplaySettings(ActionRequest actionRequest)
		...
		boolean displayAssetDescription = ParamUtil.getBoolean(actionRequest, "displayAssetDescription",true);
		...
		setPreference(actionRequest, "displayAssetDescription", String.valueOf(displayAssetDescription));
	}
	...
	/**
	 * @todo UPDATE CAU HINH CHON TIN BAI LIEN QUAN KHI HIEN THI CHI TIET 1 BAN TIN
	 * @author HungDX	
	 * @date Aug 9, 2012
	 * @return void
	 * @param actionRequest
	 */
	protected void updateRelatedAssetSettings(ActionRequest actionRequest){
		
		try {
			//Hien thi bai viet lien quan ?
			boolean displayRelatedAsset = ParamUtil.getBoolean(actionRequest, "displayRelatedAsset",true);
			
			if(displayRelatedAsset){//Truong hop co hien thi danh sach tin bai lien quan
				
				//queryName xac dinh kieu loc tin dua theo Tag hay Category
				String relatedAssetsFilter = ParamUtil.getString(actionRequest, "relatedAssetsFilter","assetCategory");
				
				//So luong tin bai hien thi
				int numbersOfRelatedAssetsDisplay = ParamUtil.getInteger(actionRequest, "numbersOfRelatedAssetsDisplay",6);
				
				//Hien thi ngay xuat ban cua tin bai lien quan?
				boolean displayRelatedAssetPublishDate = ParamUtil.getBoolean(actionRequest, "displayRelatedAssetPublishDate",true);
				
				//Luu thong tin cau hinh
				setPreference(actionRequest, "displayRelatedAsset", String.valueOf(displayRelatedAsset));
				setPreference(actionRequest, "relatedAssetsFilter", relatedAssetsFilter);
				setPreference(actionRequest, "numbersOfRelatedAssetsDisplay", String.valueOf(numbersOfRelatedAssetsDisplay));
				setPreference(actionRequest, "displayRelatedAssetPublishDate", String.valueOf(displayRelatedAssetPublishDate));
