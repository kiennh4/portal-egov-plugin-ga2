	...
	<div class="categories-admin-content-wrapper">
		<aui:layout cssClass="categories-admin-content">
			...
			<aui:column columnWidth="75" cssClass="vocabulary-categories-container">
				<div class="results-header">
					<aui:input cssClass="select-categories" inline="<%= true %>" label="" 
								name="checkAllCategories" 
								title='<%= LanguageUtil.get(pageContext, "check-all-categories") %>' type="checkbox" />
			...
			<aui:column columnWidth="40" cssClass="aui-helper-hidden vocabulary-edit-category">
				<div class="results-header">
