...
<h3><liferay-ui:message key="site-page-details" /></h3>
...
<aui:fieldset>
	<c:choose>
		<c:when test="<%= !group.isLayoutPrototype() %>">
			<aui:input name="name" label="site-page-name"/>
			...
			<aui:input label="hidden-from-navigation-menu" helpMessage="if-checked-this-page-wont-show-up-in-the-navigation-menu" name="hidden" />
	...
	<aui:select name="type" label="site-page-type">
