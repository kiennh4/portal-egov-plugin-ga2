...
<%
	...
	String[] strDayOfWeekEn = {" ", "Sun, ", "Mon, ", "Tue, ", "Wed, ",
			  "Thu, ", "Fri, ", "Sat, "
			};
	
	String assetPubLishDate = strDayOfWeekEn[dayOfWeek] + dateFormat.format(assetEntry.getPublishDate()) + " | GMT +7";
...
<div class="asset_publisher_view_full_content">
	...
	<span class = "assetPublishDate"><%=assetPubLishDate %></span>
