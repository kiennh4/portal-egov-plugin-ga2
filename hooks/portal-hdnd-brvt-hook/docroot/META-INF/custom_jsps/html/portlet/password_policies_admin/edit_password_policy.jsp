...
<aui:form action="<%= editPasswordPolicyURL %>" method="post" name="fm">
	...
	<liferay-ui:panel-container extended="<%= true %>" id="passwordPoliciesAdminPasswordPolicyPanelContainer" persistState="<%= true %>">
		<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" id="passwordPoliciesAdminPasswordPolicyGeneralPanel" persistState="<%= true %>" title="general-policy">
			<aui:fieldset>
				<aui:input disabled="<%= defaultPolicy %>" name="name" />

				<aui:input name="description" />

				<aui:input helpMessage="changeable-help" label="user-can-change-password" inlineLabel="left" name="changeable" />

				<div id="<portlet:namespace />changeableSettings">
					<aui:input helpMessage="change-required-help" label="password-change-required-in-first-login"  inlineLabel="left" name="changeRequired" />
				</div>
			</aui:fieldset>
		</liferay-ui:panel>
