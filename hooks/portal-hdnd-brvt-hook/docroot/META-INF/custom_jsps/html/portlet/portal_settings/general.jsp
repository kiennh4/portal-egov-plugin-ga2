...
<h3><liferay-ui:message key="portal-main-configuration" /></h3>
...
<aui:fieldset column="<%= true %>" cssClass="aui-w50">
	...
	<aui:input name="name" label="portal-name"/>

	<liferay-ui:error exception="<%= CompanyMxException.class %>" message="please-enter-a-valid-mail-domain" />

	<aui:input bean="<%= company %>" disabled="<%= !PropsValues.MAIL_MX_UPDATE %>" label="portal-domain" name="mx" model="<%= Company.class %>" />
</aui:fieldset>

<aui:fieldset column="<%= true %>" cssClass="aui-w50">
	<liferay-ui:error exception="<%= CompanyVirtualHostException.class %>" message="please-enter-a-valid-virtual-host" />

	<aui:input bean="<%= virtualHost %>" fieldParam="virtualHostname" label="portal-virtual-host-ip-address" model="<%= VirtualHost.class %>" name="hostname" />
...
<h3><liferay-ui:message key="portal-url-navigation" /></h3>
