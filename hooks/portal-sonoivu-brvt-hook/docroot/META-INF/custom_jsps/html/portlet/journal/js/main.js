AUI.add(
	...
	function(A) {
		...
		Journal.prototype = {
			...
			_attachEvents: function() {
				...
				var journalFormId = '#_15_fm1';
				
				window.validator = new A.FormValidator({

			        boundingBox: journalFormId,
			        rules: {
			            _15_title_vi_VN: {
			                required: true,
			                rangeLength: ['1','500']
	...
	'',
	{
		requires: ['aui-base','aui-form-validator','aui-data-set', 'aui-datatype', 'aui-dialog', 'aui-dialog-iframe', 'aui-io-request', 'aui-nested-list', 'aui-overlay-context-panel', 'json']
	}
);