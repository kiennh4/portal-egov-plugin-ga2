<div class="portal_dean_2395" id="main-content" role="main">
	<div class="portlet-layout" id="column_1_1">
	...
	<div class="portlet-layout container" id="column_2_1">
	...
	<div class="portlet-layout" id="column_3_1">
		<div class="aui-w100 portlet-column portlet-column-only" id="column-4">
			$processor.processColumn("column-4", "portlet-column-content
			portlet-column-content-only")</div>
	</div>

	<div class="portlet-layout container" id="column_4_1">
		<div class="aui-w33 portlet-column portlet-column-first" id="column-5">
			$processor.processColumn("column-5", "portlet-column-content
			portlet-column-content-first")</div>

		<div class="aui-w33 portlet-column" id="column-6">
			$processor.processColumn("column-6", "portlet-column-content")</div>

		<div class="aui-w33 portlet-column portlet-column-last" id="column-7">
