<div class="portal_gdnn" id="main-content" role="main">
		...
		<tr>
			...
			<td class="aui-w30 portlet-column portlet-column-last" id="column-8">
		...
		<tr>
			...
			<td class="aui-w30 portlet-column portlet-column-last" id="column-6">
		...
		<table class="portlet-layout">
				<tr>
			<td class="aui-w70 portlet-column portlet-column-first" id="column-7">
		...
		<div class="portlet-layout">
			...
			<div class="aui-w30 portlet-column portlet-column-last" id="column-8">
				$processor.processColumn("column-8", "portlet-column-content portlet-column-content-last")
			</div>
		</div>
		...
		<div class="portlet-layout">
			<div class="aui-w70 portlet-column portlet-column-first" id="column-7">
				$processor.processColumn("column-7", "portlet-column-content portlet-column-content-first")
			</div>
