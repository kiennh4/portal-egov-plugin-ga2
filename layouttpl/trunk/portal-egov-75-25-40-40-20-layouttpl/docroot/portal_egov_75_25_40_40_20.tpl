<div class="portal_egov_75_25_40_40_20" id="main-content" role="main">
		...
		<tr>
			...
			<td class="aui-w40 portlet-column" id="column-5">
				$processor.processColumn("column-5", "portlet-column-content")
			</td>
			<td class="aui-w20 portlet-column portlet-column-last" id="column-6">
		...
		<div class="portlet-layout">
			...
			<div class="aui-w40 portlet-column" id="column-5">
				$processor.processColumn("column-5", "portlet-column-content")
			</div>
