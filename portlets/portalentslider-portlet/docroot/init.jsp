...
<%
	...
	long sliderId = GetterUtil.getLong(preferences.getValue("sliderId", "0"), 0L);
	
	String sliderStyle = preferences.getValue("sliderStyle", "style1");
	
	String sliderPath = "/client/slider_display_style/" + sliderStyle + ".jsp";
	
	int sliderWidth = GetterUtil.getInteger(preferences.getValue("sliderWidth", StringPool.BLANK), 600);
	
	int sliderHeight = GetterUtil.getInteger(preferences.getValue("sliderHeight", StringPool.BLANK), 300);
	
	String sliderItems = preferences.getValue("sliderItems", StringPool.BLANK);
	
	/* boolean auto = GetterUtil.getBoolean(preferences.getValue("auto", String.valueOf(true)), true); */
	
	int duration = GetterUtil.getInteger(preferences.getValue("duration", String.valueOf(1000)), 1000);
	
	int durationTimeout = GetterUtil.getInteger(preferences.getValue("durationTimeout", String.valueOf(1000)), 1000);
