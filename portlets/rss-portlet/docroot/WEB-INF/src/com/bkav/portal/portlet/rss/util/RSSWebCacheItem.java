...
//
//			httpClientParams.setConnectionManagerTimeout(RSS_CONNECTION_TIMEOUT);
//			httpClientParams.setSoTimeout(RSS_CONNECTION_TIMEOUT);
//
...
//			httpClient.executeMethod(hostConfiguration, getMethod);
	...
	public static final int RSS_CONNECTION_TIMEOUT = 10000;
	
	private static final long _REFRESH_TIME = Time.MINUTE * 1;
