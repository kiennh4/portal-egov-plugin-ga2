 ...
 * @author HungDX
 */
public class BannerGroupClp extends BaseModelImpl<BannerGroup>
	implements BannerGroup {
	public BannerGroupClp() {
	}
	...
	public BaseModel<?> getBannerGroupRemoteModel() {
		return _bannerGroupRemoteModel;
	}

	public void setBannerGroupRemoteModel(BaseModel<?> bannerGroupRemoteModel) {
		_bannerGroupRemoteModel = bannerGroupRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			BannerGroupLocalServiceUtil.addBannerGroup(this);
		}
		else {
			BannerGroupLocalServiceUtil.updateBannerGroup(this);
		}
	}

	@Override
	public BannerGroup toEscapedModel() {
		return (BannerGroup)Proxy.newProxyInstance(BannerGroup.class.getClassLoader(),
			new Class[] { BannerGroup.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		BannerGroupClp clone = new BannerGroupClp();
		...
		clone.setGroupDesc(getGroupDesc());
	...
	public boolean equals(Object obj) {
		...
		BannerGroupClp bannerGroup = null;

		try {
			bannerGroup = (BannerGroupClp)obj;
		}
	...
	private BaseModel<?> _bannerGroupRemoteModel;
}