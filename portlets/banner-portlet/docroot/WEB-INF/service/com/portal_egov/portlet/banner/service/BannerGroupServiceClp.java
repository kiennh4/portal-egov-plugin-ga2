 ...
 * @author HungDX
 */
public class BannerGroupServiceClp implements BannerGroupService {
	public BannerGroupServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getBannerGroups";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "deleteBannerGroup";
	...
	public void deleteBannerGroup(long groupId, long bannerGroupId)
		...
		try {
			_invokableService.invokeMethod(_methodName4,
				_methodParameterTypes4, new Object[] { groupId, bannerGroupId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
