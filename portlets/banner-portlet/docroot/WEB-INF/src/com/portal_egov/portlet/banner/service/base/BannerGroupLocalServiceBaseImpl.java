...
/**
 * The base implementation of the banner group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portal_egov.portlet.banner.service.impl.BannerGroupLocalServiceImpl}.
 * </p>
 *
 * @author HungDX
 ...
 * @generated
 */
public abstract class BannerGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BannerGroupLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.portal_egov.portlet.banner.service.BannerGroupLocalServiceUtil} to access the banner group local service.
	 */
	...
	public BannerGroup addBannerGroup(BannerGroup bannerGroup)
		throws SystemException {
		bannerGroup.setNew(true);

		return bannerGroupPersistence.update(bannerGroup, false);
	}
	 ...
	 */
	public BannerGroup createBannerGroup(long bannerGroupId) {
		return bannerGroupPersistence.create(bannerGroupId);
	}
	...
	public BannerGroup deleteBannerGroup(long bannerGroupId)
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public BannerGroup deleteBannerGroup(BannerGroup bannerGroup)
		throws SystemException {
		return bannerGroupPersistence.remove(bannerGroup);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(BannerGroup.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return bannerGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return bannerGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bannerGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public BannerGroup fetchBannerGroup(long bannerGroupId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public BannerGroup getBannerGroup(long bannerGroupId)
		throws PortalException, SystemException {
		return bannerGroupPersistence.findByPrimaryKey(bannerGroupId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bannerGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<BannerGroup> getBannerGroups(int start, int end)
		throws SystemException {
		return bannerGroupPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getBannerGroupsCount() throws SystemException {
		return bannerGroupPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BannerGroup updateBannerGroup(BannerGroup bannerGroup)
		throws SystemException {
		return updateBannerGroup(bannerGroup, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BannerGroup updateBannerGroup(BannerGroup bannerGroup, boolean merge)
		throws SystemException {
		bannerGroup.setNew(false);

		return bannerGroupPersistence.update(bannerGroup, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.portal_egov.portlet.banner.model.BannerGroup",
			bannerGroupLocalService);
	}
	...
	private BannerGroupLocalServiceClpInvoker _clpInvoker = new BannerGroupLocalServiceClpInvoker();
}