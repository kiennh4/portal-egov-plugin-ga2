...
/**
 * The utility for the weblink category local service. This utility wraps {@link com.portal_egov.portlet.weblinks.service.impl.WeblinkCategoryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.portal_egov.portlet.weblinks.service.impl.WeblinkCategoryLocalServiceImpl
 * @generated
 */
public class WeblinkCategoryLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.portal_egov.portlet.weblinks.service.impl.WeblinkCategoryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory addWeblinkCategory(
		com.portal_egov.portlet.weblinks.model.WeblinkCategory weblinkCategory)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addWeblinkCategory(weblinkCategory);
	}
	...
	*/
	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory createWeblinkCategory(
		long categoryId) {
		return getService().createWeblinkCategory(categoryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory deleteWeblinkCategory(
		long categoryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteWeblinkCategory(categoryId);
	}
	...
	*/
	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory deleteWeblinkCategory(
		com.portal_egov.portlet.weblinks.model.WeblinkCategory weblinkCategory)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteWeblinkCategory(weblinkCategory);
	}
	...
	*/
	...
	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory fetchWeblinkCategory(
		long categoryId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchWeblinkCategory(categoryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory getWeblinkCategory(
		long categoryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getWeblinkCategory(categoryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.portal_egov.portlet.weblinks.model.WeblinkCategory> getWeblinkCategories(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getWeblinkCategories(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getWeblinkCategoriesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getWeblinkCategoriesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory updateWeblinkCategory(
		com.portal_egov.portlet.weblinks.model.WeblinkCategory weblinkCategory)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateWeblinkCategory(weblinkCategory);
	}
	...
	*/
	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory updateWeblinkCategory(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateWeblinkCategory(weblinkCategory, merge);
	}
	...
	*/
	...
	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory addCategory(
		...
		return getService()
			...
			categoryName, categoryDesc, categoryIconId, serviceContext);
	}

	public static com.portal_egov.portlet.weblinks.model.WeblinkCategory updateCategory(
		long companyId, long groupId, long userId, java.lang.String userName,
		...
		return getService()
			...
			categoryId, categoryName, categoryDesc, categoryIconId);
	}

	public static void deleteCategory(long categoryId, boolean deleteWeblinks)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteCategory(categoryId, deleteWeblinks);
	}
	...
	public static WeblinkCategoryLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WeblinkCategoryLocalService.class.getName());

			if (invokableLocalService instanceof WeblinkCategoryLocalService) {
				_service = (WeblinkCategoryLocalService)invokableLocalService;
			}
			else {
				_service = new WeblinkCategoryLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(WeblinkCategoryLocalServiceUtil.class,
				"_service");
		}
	 ...
	 * @deprecated
	 */
	public void setService(WeblinkCategoryLocalService service) {
	}

	private static WeblinkCategoryLocalService _service;
}