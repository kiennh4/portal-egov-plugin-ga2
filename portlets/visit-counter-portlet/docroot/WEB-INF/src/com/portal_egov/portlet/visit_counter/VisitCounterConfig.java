...
public class VisitCounterConfig extends DefaultConfigurationAction {
	@Override
	public void processAction(PortletConfig portletConfig,
		...
		try {
			...
			String displayStyle = ParamUtil.getString(actionRequest, "displayStyle","style-1");
	...
	private static Log _log = LogFactory.getLog(VisitCounterConfig.class);
}