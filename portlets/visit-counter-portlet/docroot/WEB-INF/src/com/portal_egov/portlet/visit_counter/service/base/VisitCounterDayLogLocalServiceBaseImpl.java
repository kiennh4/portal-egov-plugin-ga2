...
/**
 * The base implementation of the visit counter day log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portal_egov.portlet.visit_counter.service.impl.VisitCounterDayLogLocalServiceImpl}.
 * </p>
 *
 * @author HungDX
 ...
 * @generated
 */
public abstract class VisitCounterDayLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VisitCounterDayLogLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.portal_egov.portlet.visit_counter.service.VisitCounterDayLogLocalServiceUtil} to access the visit counter day log local service.
	 */
	...
	public VisitCounterDayLog addVisitCounterDayLog(
		VisitCounterDayLog visitCounterDayLog) throws SystemException {
		visitCounterDayLog.setNew(true);

		return visitCounterDayLogPersistence.update(visitCounterDayLog, false);
	}
	 ...
	 */
	public VisitCounterDayLog createVisitCounterDayLog(String daylogId) {
		return visitCounterDayLogPersistence.create(daylogId);
	}
	...
	public VisitCounterDayLog deleteVisitCounterDayLog(String daylogId)
		throws PortalException, SystemException {
		return visitCounterDayLogPersistence.remove(daylogId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public VisitCounterDayLog deleteVisitCounterDayLog(
		VisitCounterDayLog visitCounterDayLog) throws SystemException {
		return visitCounterDayLogPersistence.remove(visitCounterDayLog);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(VisitCounterDayLog.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return visitCounterDayLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return visitCounterDayLogPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VisitCounterDayLog fetchVisitCounterDayLog(String daylogId)
		throws SystemException {
		return visitCounterDayLogPersistence.fetchByPrimaryKey(daylogId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VisitCounterDayLog getVisitCounterDayLog(String daylogId)
		throws PortalException, SystemException {
		return visitCounterDayLogPersistence.findByPrimaryKey(daylogId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return visitCounterDayLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VisitCounterDayLog> getVisitCounterDayLogs(int start, int end)
		throws SystemException {
		return visitCounterDayLogPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVisitCounterDayLogsCount() throws SystemException {
		return visitCounterDayLogPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public VisitCounterDayLog updateVisitCounterDayLog(
		VisitCounterDayLog visitCounterDayLog) throws SystemException {
		return updateVisitCounterDayLog(visitCounterDayLog, true);
	}
	...
	public VisitCounterDayLog updateVisitCounterDayLog(
		...
		return visitCounterDayLogPersistence.update(visitCounterDayLog, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.portal_egov.portlet.visit_counter.model.VisitCounterDayLog",
			visitCounterDayLogLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = visitCounterDayLogPersistence.getDataSource();
	...
	private VisitCounterDayLogLocalServiceClpInvoker _clpInvoker = new VisitCounterDayLogLocalServiceClpInvoker();
}