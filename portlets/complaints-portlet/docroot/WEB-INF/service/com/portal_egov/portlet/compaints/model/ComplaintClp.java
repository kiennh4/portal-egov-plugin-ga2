 ...
 * @author HungDX
 */
public class ComplaintClp extends BaseModelImpl<Complaint> implements Complaint {
	public ComplaintClp() {
	}
	...
	public BaseModel<?> getComplaintRemoteModel() {
		return _complaintRemoteModel;
	}

	public void setComplaintRemoteModel(BaseModel<?> complaintRemoteModel) {
		_complaintRemoteModel = complaintRemoteModel;
	}
	...
	public Complaint toEscapedModel() {
		return (Complaint)Proxy.newProxyInstance(Complaint.class.getClassLoader(),
			new Class[] { Complaint.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		ComplaintClp clone = new ComplaintClp();
		...
		clone.setComplaintDescription(getComplaintDescription());
		clone.setComplaintContent(getComplaintContent());
		clone.setFileAttachmentURL(getFileAttachmentURL());
		clone.setComplaintStatus(getComplaintStatus());
	...
	public boolean equals(Object obj) {
		...
		ComplaintClp complaint = null;

		try {
			complaint = (ComplaintClp)obj;
		}
	...
	private BaseModel<?> _complaintRemoteModel;
}