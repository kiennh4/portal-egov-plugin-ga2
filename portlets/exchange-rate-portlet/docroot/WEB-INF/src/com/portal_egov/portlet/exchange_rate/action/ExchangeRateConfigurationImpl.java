package com.portal_egov.portlet.exchange_rate.action;
...
public class ExchangeRateConfigurationImpl extends DefaultConfigurationAction{
	...
	private static Log _log = LogFactory.getLog(ExchangeRateConfigurationImpl.class);
}