 ...
 * @author HungDX
 */
public class TTHC_CategoryLocalServiceClp implements TTHC_CategoryLocalService {
	public TTHC_CategoryLocalServiceClp(
		...
		_methodName24 = "countByTypeAndCompany";

		_methodParameterTypes24 = new String[] { "int", "long" };

		_methodName25 = "countByTypeAndGroup";
		...
		_methodName31 = "findByParentAndCompany";
		...
		_methodName33 = "findByParentAndGroup";
		...
		_methodName35 = "findByTypeAndCompany";

		_methodParameterTypes35 = new String[] { "int", "long", "int", "int" };

		_methodName36 = "findByTypeAndGroup";

		_methodParameterTypes36 = new String[] { "int", "long" };

		_methodName37 = "findByTypeAndGroup";

		_methodParameterTypes37 = new String[] { "int", "long", "int", "int" };

		_methodName38 = "findByKeyword";

		_methodParameterTypes38 = new String[] {
				"long", "int", "java.lang.String", "int", "int"
			};

		_methodName39 = "addTTHCCategory";
		...
		_methodName40 = "updateTTHCCategory";
		...
		_methodName41 = "deleteTTHCCategory";
	...
	public com.portal_egov.portlet.tthc.model.TTHC_Category addTTHC_Category(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(tthc_Category) });
		}
		catch (Throwable t) {
		...
		return (com.portal_egov.portlet.tthc.model.TTHC_Category)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.portal_egov.portlet.tthc.model.TTHC_Category> getTTHC_Categories(
		...
		return (java.util.List<com.portal_egov.portlet.tthc.model.TTHC_Category>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.portal_egov.portlet.tthc.model.TTHC_Category updateTTHC_Category(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] {
						ClpSerializer.translateInput(tthc_Category),
	...
	public int countByParentAndGroup(long parentId, long groupId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					_methodParameterTypes23, new Object[] { parentId, groupId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public int countByTypeAndCompany(int categoryTypeId, long companyId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName24,
					...
					new Object[] { categoryTypeId, companyId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public int countByTypeAndGroup(int categoryTypeId, long groupId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName25,
					...
					new Object[] { categoryTypeId, groupId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.portal_egov.portlet.tthc.model.TTHC_Category> findByParentAndCompany(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName31,
					...
					new Object[] { parentId, companyId, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.portal_egov.portlet.tthc.model.TTHC_Category> findByParentAndGroup(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName32,
					_methodParameterTypes32, new Object[] { parentId, groupId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.portal_egov.portlet.tthc.model.TTHC_Category> findByParentAndGroup(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName33,
					...
					new Object[] { parentId, groupId, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.portal_egov.portlet.tthc.model.TTHC_Category> findByTypeAndCompany(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName35,
					...
					new Object[] { categoryTypeId, companyId, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.portal_egov.portlet.tthc.model.TTHC_Category> findByTypeAndGroup(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName37,
					...
					new Object[] { categoryTypeId, groupId, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void deleteTTHCCategory(long categoryId)
		...
		try {
			_invokableLocalService.invokeMethod(_methodName41,
				_methodParameterTypes41, new Object[] { categoryId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
