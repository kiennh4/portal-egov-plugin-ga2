...
public class TTHCLastestEntriesConfig extends DefaultConfigurationAction{
	...
	public String render(PortletConfig portletConfig,
			...
			throws Exception {
		return "/html/tthc_lastest_entries_portlet/config.jsp";
	}
	private static Log _log = LogFactory.getLog(TTHCLastestEntriesConfig.class);
}