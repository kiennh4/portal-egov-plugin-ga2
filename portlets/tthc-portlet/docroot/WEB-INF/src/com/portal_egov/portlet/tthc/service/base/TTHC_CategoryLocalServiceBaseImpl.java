...
/**
 * The base implementation of the t t h c_ category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portal_egov.portlet.tthc.service.impl.TTHC_CategoryLocalServiceImpl}.
 * </p>
 *
 * @author HungDX
 ...
 * @generated
 */
public abstract class TTHC_CategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TTHC_CategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.portal_egov.portlet.tthc.service.TTHC_CategoryLocalServiceUtil} to access the t t h c_ category local service.
	 */
	...
	public TTHC_Category addTTHC_Category(TTHC_Category tthc_Category)
		throws SystemException {
		tthc_Category.setNew(true);

		return tthc_CategoryPersistence.update(tthc_Category, false);
	}
	 ...
	 */
	public TTHC_Category createTTHC_Category(long categoryId) {
		return tthc_CategoryPersistence.create(categoryId);
	}
	...
	public TTHC_Category deleteTTHC_Category(long categoryId)
		throws PortalException, SystemException {
		return tthc_CategoryPersistence.remove(categoryId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TTHC_Category deleteTTHC_Category(TTHC_Category tthc_Category)
		throws SystemException {
		return tthc_CategoryPersistence.remove(tthc_Category);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TTHC_Category.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthc_CategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthc_CategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TTHC_Category fetchTTHC_Category(long categoryId)
		throws SystemException {
		return tthc_CategoryPersistence.fetchByPrimaryKey(categoryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TTHC_Category getTTHC_Category(long categoryId)
		throws PortalException, SystemException {
		return tthc_CategoryPersistence.findByPrimaryKey(categoryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthc_CategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TTHC_Category> getTTHC_Categories(int start, int end)
		throws SystemException {
		return tthc_CategoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTTHC_CategoriesCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TTHC_Category updateTTHC_Category(TTHC_Category tthc_Category)
		throws SystemException {
		return updateTTHC_Category(tthc_Category, true);
	}
	...
	public TTHC_Category updateTTHC_Category(TTHC_Category tthc_Category,
		...
		return tthc_CategoryPersistence.update(tthc_Category, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.portal_egov.portlet.tthc.model.TTHC_Category",
			tthc_CategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthc_CategoryPersistence.getDataSource();
	...
	private TTHC_CategoryLocalServiceClpInvoker _clpInvoker = new TTHC_CategoryLocalServiceClpInvoker();
}