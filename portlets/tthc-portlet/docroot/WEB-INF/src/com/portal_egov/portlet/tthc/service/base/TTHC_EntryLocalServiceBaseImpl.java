...
/**
 * The base implementation of the t t h c_ entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portal_egov.portlet.tthc.service.impl.TTHC_EntryLocalServiceImpl}.
 * </p>
 *
 * @author HungDX
 ...
 * @generated
 */
public abstract class TTHC_EntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TTHC_EntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.portal_egov.portlet.tthc.service.TTHC_EntryLocalServiceUtil} to access the t t h c_ entry local service.
	 */
	...
	public TTHC_Entry addTTHC_Entry(TTHC_Entry tthc_Entry)
		throws SystemException {
		tthc_Entry.setNew(true);

		return tthc_EntryPersistence.update(tthc_Entry, false);
	}
	 ...
	 */
	public TTHC_Entry createTTHC_Entry(long entryId) {
		return tthc_EntryPersistence.create(entryId);
	}
	...
	public TTHC_Entry deleteTTHC_Entry(long entryId)
		throws PortalException, SystemException {
		return tthc_EntryPersistence.remove(entryId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TTHC_Entry deleteTTHC_Entry(TTHC_Entry tthc_Entry)
		throws SystemException {
		return tthc_EntryPersistence.remove(tthc_Entry);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TTHC_Entry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthc_EntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return tthc_EntryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthc_EntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TTHC_Entry fetchTTHC_Entry(long entryId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TTHC_Entry getTTHC_Entry(long entryId)
		throws PortalException, SystemException {
		return tthc_EntryPersistence.findByPrimaryKey(entryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthc_EntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TTHC_Entry> getTTHC_Entries(int start, int end)
		throws SystemException {
		return tthc_EntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTTHC_EntriesCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TTHC_Entry updateTTHC_Entry(TTHC_Entry tthc_Entry)
		throws SystemException {
		return updateTTHC_Entry(tthc_Entry, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TTHC_Entry updateTTHC_Entry(TTHC_Entry tthc_Entry, boolean merge)
		throws SystemException {
		tthc_Entry.setNew(false);

		return tthc_EntryPersistence.update(tthc_Entry, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.portal_egov.portlet.tthc.model.TTHC_Entry",
			tthc_EntryLocalService);
	}
	...
	private TTHC_EntryLocalServiceClpInvoker _clpInvoker = new TTHC_EntryLocalServiceClpInvoker();
}