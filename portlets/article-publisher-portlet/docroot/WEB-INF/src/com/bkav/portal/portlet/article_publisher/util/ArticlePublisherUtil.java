...
package com.bkav.portal.portlet.article_publisher.util;
...
import com.bkav.portal.portlet.article_publisher.cache.MemcacheUtil;
...
public class ArticlePublisherUtil {
	...
	public static String selectedCategoryValidate(String selectedCategoryIds) {

		try {

			StringBuilder sb = new StringBuilder();

			String[] selectedCategoryArr = selectedCategoryIds.split(",");

			for (String categoryIdStr : selectedCategoryArr) {

				AssetCategory category =
					AssetCategoryLocalServiceUtil.fetchAssetCategory(GetterUtil.getLong(categoryIdStr));
			...
			selectedCategoryIds = sb.toString();

			if (selectedCategoryIds.endsWith(StringPool.COMMA)) {
	...
	public static List<AssetEntryCache> getAssetsById (HttpServletRequest request, int numbersOfDetailEntry, String queryValue) 
	{
		...
		try 
		{
			...
			String[] queryValues = new String[]{queryValue};
	...
	public static List<AssetEntryCache> getAssetList(HttpServletRequest request, int numbersOfDetailEntry) {
	...
	private static Log _log = LogFactory.getLog(ArticlePublisherUtil.class);
