 ...
 * @author HungDX
 */
public class LandPriceLocalServiceClp implements LandPriceLocalService {
	public LandPriceLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName20 = "findByLocation";

		_methodParameterTypes20 = new String[] { "long" };

		_methodName21 = "findByStatisticYear";
	...
	public com.portal_egov.portlet.landprice.model.LandPrice addLandPrice(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(landPrice) });
		}
		catch (Throwable t) {
		...
		return (com.portal_egov.portlet.landprice.model.LandPrice)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.portal_egov.portlet.landprice.model.LandPrice createLandPrice(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { priceId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.portal_egov.portlet.landprice.model.LandPrice deleteLandPrice(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { priceId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
			...
			if (t instanceof com.portal_egov.portlet.landprice.NoSuchLandPriceException) {
				throw (com.portal_egov.portlet.landprice.NoSuchLandPriceException)t;
			}
	...
	public com.portal_egov.portlet.landprice.model.LandPrice fetchLandPrice(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { priceId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.portal_egov.portlet.landprice.model.LandPrice getLandPrice(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { priceId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.portal_egov.portlet.landprice.model.LandPrice> getLandPrices(
		...
		return (java.util.List<com.portal_egov.portlet.landprice.model.LandPrice>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.portal_egov.portlet.landprice.model.LandPrice updateLandPrice(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(landPrice), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.portal_egov.portlet.landprice.model.LandPrice> findByStatisticYear(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					_methodParameterTypes21, new Object[] { statisticYear });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
