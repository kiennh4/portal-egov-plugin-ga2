...
/**
 * The base implementation of the land location local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portal_egov.portlet.landprice.service.impl.LandLocationLocalServiceImpl}.
 * </p>
 *
 * @author HungDX
 ...
 * @generated
 */
public abstract class LandLocationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LandLocationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.portal_egov.portlet.landprice.service.LandLocationLocalServiceUtil} to access the land location local service.
	 */
	...
	public LandLocation addLandLocation(LandLocation landLocation)
		throws SystemException {
		landLocation.setNew(true);

		return landLocationPersistence.update(landLocation, false);
	}
	 ...
	 */
	public LandLocation createLandLocation(long locationId) {
		return landLocationPersistence.create(locationId);
	}
	...
	public LandLocation deleteLandLocation(long locationId)
		throws PortalException, SystemException {
		return landLocationPersistence.remove(locationId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LandLocation deleteLandLocation(LandLocation landLocation)
		throws SystemException {
		return landLocationPersistence.remove(landLocation);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(LandLocation.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return landLocationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return landLocationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public LandLocation fetchLandLocation(long locationId)
		throws SystemException {
		return landLocationPersistence.fetchByPrimaryKey(locationId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LandLocation getLandLocation(long locationId)
		throws PortalException, SystemException {
		return landLocationPersistence.findByPrimaryKey(locationId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return landLocationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LandLocation> getLandLocations(int start, int end)
		throws SystemException {
		return landLocationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLandLocationsCount() throws SystemException {
		return landLocationPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LandLocation updateLandLocation(LandLocation landLocation)
		throws SystemException {
		return updateLandLocation(landLocation, true);
	}
	...
	public LandLocation updateLandLocation(LandLocation landLocation,
		...
		return landLocationPersistence.update(landLocation, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.portal_egov.portlet.landprice.model.LandLocation",
			landLocationLocalService);
	}
	...
	private LandLocationLocalServiceClpInvoker _clpInvoker = new LandLocationLocalServiceClpInvoker();
}