...
import com.bkav.portal.portlet.employee.model.impl.DepartmentModelImpl;
...
public class DepartmentPersistenceImpl extends BasePersistenceImpl<Department>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANY = new FinderPath(DepartmentModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANY = new FinderPath(DepartmentModelImpl.ENTITY_CACHE_ENABLED,
			DepartmentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCompany",
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUP = new FinderPath(DepartmentModelImpl.ENTITY_CACHE_ENABLED,
			DepartmentModelImpl.FINDER_CACHE_ENABLED, DepartmentImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUP = new FinderPath(DepartmentModelImpl.ENTITY_CACHE_ENABLED,
			DepartmentModelImpl.FINDER_CACHE_ENABLED, DepartmentImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroup",
			new String[] { Long.class.getName() },
			DepartmentModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUP = new FinderPath(DepartmentModelImpl.ENTITY_CACHE_ENABLED,
			DepartmentModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	public Department remove(long depId)
		throws NoSuchDepartmentException, SystemException {
		return remove(Long.valueOf(depId));
	}
	...
	protected Department toUnwrappedModel(Department department) {
		...
		departmentImpl.setDepId(department.getDepId());
		...
		departmentImpl.setDepName(department.getDepName());
		departmentImpl.setDepAddres(department.getDepAddres());
		departmentImpl.setDepPhone(department.getDepPhone());
	...
	public Department findByPrimaryKey(long depId)
		throws NoSuchDepartmentException, SystemException {
		Department department = fetchByPrimaryKey(depId);

		if (department == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + depId);
			}
		...
		if (department == null) {
			...
			try {
				...
				if (department != null) {
					...
					EntityCacheUtil.putResult(DepartmentModelImpl.ENTITY_CACHE_ENABLED,
						DepartmentImpl.class, depId, _nullDepartment);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Department> findByCompany(long companyId, int start, int end)
		throws SystemException {
	...
	public List<Department> findByCompany(long companyId, int start, int end,
		...
		if (list == null) {
			...
			try {
				...
				list = (List<Department>)QueryUtil.list(q, getDialect(), start,
						end);
			}
			catch (Exception e) {
				throw processException(e);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department findByCompany_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchDepartmentException, SystemException {
		Department department = fetchByCompany_First(companyId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department fetchByCompany_First(long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Department> list = findByCompany(companyId, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department findByCompany_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchDepartmentException, SystemException {
		Department department = fetchByCompany_Last(companyId, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department fetchByCompany_Last(long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByCompany(companyId);

		List<Department> list = findByCompany(companyId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department[] findByCompany_PrevAndNext(long depId, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchDepartmentException, SystemException {
		...
		try {
			...
			array[0] = getByCompany_PrevAndNext(session, department, companyId,
					orderByComparator, true);

			array[1] = department;

			array[2] = getByCompany_PrevAndNext(session, department, companyId,
	...
	protected Department getByCompany_PrevAndNext(Session session,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Department> findByGroup(long groupId, int start, int end)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department findByGroup_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchDepartmentException, SystemException {
		Department department = fetchByGroup_First(groupId, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department fetchByGroup_First(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Department> list = findByGroup(groupId, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department findByGroup_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchDepartmentException, SystemException {
		Department department = fetchByGroup_Last(groupId, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department fetchByGroup_Last(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByGroup(groupId);

		List<Department> list = findByGroup(groupId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department[] findByGroup_PrevAndNext(long depId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchDepartmentException, SystemException {
		Department department = findByPrimaryKey(depId);
		...
		try {
			...
			array[0] = getByGroup_PrevAndNext(session, department, groupId,
					orderByComparator, true);

			array[1] = department;

			array[2] = getByGroup_PrevAndNext(session, department, groupId,
					orderByComparator, false);
	...
	protected Department getByGroup_PrevAndNext(Session session,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Department> filterFindByGroup(long groupId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Department> filterFindByGroup(long groupId, int start, int end)
		throws SystemException {
	...
	public List<Department> filterFindByGroup(long groupId, int start, int end,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_DEPARTMENT_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_DEPARTMENT_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUP_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_DEPARTMENT_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(DepartmentModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, DepartmentImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, DepartmentImpl.class);
			}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department[] filterFindByGroup_PrevAndNext(long depId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchDepartmentException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroup_PrevAndNext(depId, groupId, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroup_PrevAndNext(session, department,
					groupId, orderByComparator, true);

			array[1] = department;

			array[2] = filterGetByGroup_PrevAndNext(session, department,
	...
	protected Department filterGetByGroup_PrevAndNext(Session session,
		Department department, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByCompany(long companyId) throws SystemException {
		for (Department department : findByCompany(companyId)) {
			remove(department);
		}
	}
	...
	public void removeByGroup(long groupId) throws SystemException {
		for (Department department : findByGroup(groupId)) {
			remove(department);
		}
	}
	...
	public int filterCountByGroup(long groupId) throws SystemException {
		...
		query.append(_FILTER_SQL_COUNT_DEPARTMENT_WHERE);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.bkav.portal.portlet.employee.model.Department")));
	...
	private static final String _FINDER_COLUMN_COMPANY_COMPANYID_2 = "department.companyId = ?";
	private static final String _FINDER_COLUMN_GROUP_GROUPID_2 = "department.groupId = ?";
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "department.depId";
	private static final String _FILTER_SQL_SELECT_DEPARTMENT_WHERE = "SELECT DISTINCT {department.*} FROM Department department WHERE ";
	private static final String _FILTER_SQL_SELECT_DEPARTMENT_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {Department.*} FROM (SELECT DISTINCT department.depId FROM Department department WHERE ";
	private static final String _FILTER_SQL_SELECT_DEPARTMENT_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN Department ON TEMP_TABLE.depId = Department.depId";
	private static final String _FILTER_SQL_COUNT_DEPARTMENT_WHERE = "SELECT COUNT(DISTINCT department.depId) AS COUNT_VALUE FROM Department department WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "department";
	private static final String _FILTER_ENTITY_TABLE = "Department";
	private static final String _ORDER_BY_ENTITY_ALIAS = "department.";
	private static final String _ORDER_BY_ENTITY_TABLE = "Department.";
