...
/**
 * The base implementation of the post local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.bkav.portal.portlet.employee.service.impl.PostLocalServiceImpl}.
 * </p>
 *
 * @author ducdvd
...
public abstract class PostLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.bkav.portal.portlet.employee.service.PostLocalServiceUtil} to access the post local service.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Post updatePost(Post post, boolean merge) throws SystemException {
		post.setNew(false);

		return postPersistence.update(post, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.bkav.portal.portlet.employee.model.Post",
			postLocalService);
	}
