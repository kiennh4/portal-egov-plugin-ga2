...
import com.bkav.portal.portlet.topic.service.TopicLocalService;
import com.bkav.portal.portlet.topic.service.TopicService;
import com.bkav.portal.portlet.topic.service.persistence.TopicFinder;
import com.bkav.portal.portlet.topic.service.persistence.TopicPersistence;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.bkav.portal.portlet.topic.service.impl.TopicLocalServiceImpl}.
 * </p>
 *
 * @author anhbdb
...
public abstract class TopicLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.bkav.portal.portlet.topic.service.TopicLocalServiceUtil} to access the topic local service.
	 */
	...
	public Topic addTopic(Topic topic) throws SystemException {
		...
		return topicPersistence.update(topic, false);
	}
	...
	public Topic updateTopic(Topic topic, boolean merge)
		...
		return topicPersistence.update(topic, merge);
	}
	...
	/**
	 * Returns the topic finder.
	 *
	 * @return the topic finder
	 */
	public TopicFinder getTopicFinder() {
		return topicFinder;
	}

	/**
	 * Sets the topic finder.
	 *
	 * @param topicFinder the topic finder
	 */
	public void setTopicFinder(TopicFinder topicFinder) {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.bkav.portal.portlet.topic.model.Topic",
			topicLocalService);
	}
	...
	@BeanReference(type = TopicFinder.class)
	protected TopicFinder topicFinder;
