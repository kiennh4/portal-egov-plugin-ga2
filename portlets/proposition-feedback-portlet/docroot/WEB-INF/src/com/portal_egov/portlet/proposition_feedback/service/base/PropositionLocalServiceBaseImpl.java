...
/**
 * The base implementation of the proposition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portal_egov.portlet.proposition_feedback.service.impl.PropositionLocalServiceImpl}.
 * </p>
 *
 * @author HungDX
 ...
 * @generated
 */
public abstract class PropositionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PropositionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.portal_egov.portlet.proposition_feedback.service.PropositionLocalServiceUtil} to access the proposition local service.
	 */
	...
	public Proposition addProposition(Proposition proposition)
		...
		return propositionPersistence.update(proposition, false);
	}
	 ...
	 */
	public Proposition createProposition(long propositionId) {
		return propositionPersistence.create(propositionId);
	}
	...
	public Proposition deleteProposition(long propositionId)
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Proposition deleteProposition(Proposition proposition)
		throws SystemException {
		return propositionPersistence.remove(proposition);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Proposition.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return propositionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return propositionPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return propositionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Proposition fetchProposition(long propositionId)
		throws SystemException {
		return propositionPersistence.fetchByPrimaryKey(propositionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Proposition getProposition(long propositionId)
		throws PortalException, SystemException {
		return propositionPersistence.findByPrimaryKey(propositionId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return propositionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Proposition> getPropositions(int start, int end)
		throws SystemException {
		return propositionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPropositionsCount() throws SystemException {
	...
	public Proposition updateProposition(Proposition proposition)
		throws SystemException {
		return updateProposition(proposition, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Proposition updateProposition(Proposition proposition, boolean merge)
		throws SystemException {
		proposition.setNew(false);

		return propositionPersistence.update(proposition, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.portal_egov.portlet.proposition_feedback.model.Proposition",
			propositionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = propositionPersistence.getDataSource();
	...
	private PropositionLocalServiceClpInvoker _clpInvoker = new PropositionLocalServiceClpInvoker();
}