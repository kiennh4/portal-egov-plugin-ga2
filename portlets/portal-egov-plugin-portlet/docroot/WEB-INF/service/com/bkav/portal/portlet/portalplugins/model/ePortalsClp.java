 ...
 * @author AnhBDb
 */
public class ePortalsClp extends BaseModelImpl<ePortals> implements ePortals {
	public ePortalsClp() {
	}
	...
	public BaseModel<?> getePortalsRemoteModel() {
		return _ePortalsRemoteModel;
	}

	public void setePortalsRemoteModel(BaseModel<?> ePortalsRemoteModel) {
		_ePortalsRemoteModel = ePortalsRemoteModel;
	}
	...
	public ePortals toEscapedModel() {
		return (ePortals)Proxy.newProxyInstance(ePortals.class.getClassLoader(),
			new Class[] { ePortals.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		ePortalsClp clone = new ePortalsClp();

		clone.setEportalId(getEportalId());
		clone.setEportalName(getEportalName());
		clone.setEportalCode(getEportalCode());
		clone.setEportalDomain(getEportalDomain());
		clone.setEportalVersion(getEportalVersion());
	...
	public boolean equals(Object obj) {
		...
		ePortalsClp ePortals = null;

		try {
			ePortals = (ePortalsClp)obj;
		}
	...
	private BaseModel<?> _ePortalsRemoteModel;
}