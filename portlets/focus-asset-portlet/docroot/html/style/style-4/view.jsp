...
<%
	List<AssetEntryCache> firstTabAssetList = FocusAssetUtil.getTabAssetList(request,
	FocusAssetConstants.STYLE_2_TAB_PARAM_PREFIXS[0]);
%>
<div class="focus-asset-display-style-4">
	...
	<div style = "width: 100%; border: 1px solid #d2d2d2;border-top:none;">
		<div class="asset-summary-container">
			<div id="<portlet:namespace/>asset-summary-content" class="asset-summary-content">
				...
				<div id = "<portlet:namespace/>asset-description" style = "margin-left:8px; padding: 10px; padding-top:0px">
		...
		<div class="tab-content-container">
			<div id="<portlet:namespace/>tab-assets-container" class="tab-assets-container">
				<liferay-util:include page="/html/style/style-4/tab-assets.jsp" servletContext="<%=getServletContext() %>"/>
			</div>
		</div>
		<div style="clear: both;"></div>
	</div>
...
<liferay-portlet:renderURL var="tabAssetsURL" windowState="<%=LiferayWindowState.EXCLUSIVE.toString() %>">
	<liferay-portlet:param name="jspPage" value="/html/style/style-4/tab-assets.jsp"/>
...
<aui:script>
	...
	Liferay.provide(
		...
		function(assetList) {
			...
			assetDescription.text(currentNode.getAttribute('data-assetShortContent'));
	...
	Liferay.provide(
		...
		function(focusAsset) {
			...
			assetDescription.text(focusAsset.getAttribute('data-assetShortContent'));
