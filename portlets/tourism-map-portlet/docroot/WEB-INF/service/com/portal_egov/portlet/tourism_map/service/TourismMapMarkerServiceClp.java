 ...
 * @author HungDX
 */
public class TourismMapMarkerServiceClp implements TourismMapMarkerService {
	public TourismMapMarkerServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getMarker";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "getJSONMarkersByGroup";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getJSONMarkers";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "deleteMarker";
	...
	public com.portal_egov.portlet.tourism_map.model.TourismMapMarker getMarker(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { markerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
		...
		return (com.portal_egov.portlet.tourism_map.model.TourismMapMarker)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.liferay.portal.kernel.json.JSONObject getJSONMarkersByGroup(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName4,
					_methodParameterTypes4, new Object[] { markerGroupId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void deleteMarker(long markerId)
		...
		try {
			_invokableService.invokeMethod(_methodName6,
				_methodParameterTypes6, new Object[] { markerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
