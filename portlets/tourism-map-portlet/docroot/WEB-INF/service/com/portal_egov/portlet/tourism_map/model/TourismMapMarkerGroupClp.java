 ...
 * @author HungDX
 */
public class TourismMapMarkerGroupClp extends BaseModelImpl<TourismMapMarkerGroup>
	implements TourismMapMarkerGroup {
	public TourismMapMarkerGroupClp() {
	}
	...
	public BaseModel<?> getTourismMapMarkerGroupRemoteModel() {
		return _tourismMapMarkerGroupRemoteModel;
	}

	public void setTourismMapMarkerGroupRemoteModel(
		BaseModel<?> tourismMapMarkerGroupRemoteModel) {
		_tourismMapMarkerGroupRemoteModel = tourismMapMarkerGroupRemoteModel;
	}
	...
	public TourismMapMarkerGroup toEscapedModel() {
		return (TourismMapMarkerGroup)Proxy.newProxyInstance(TourismMapMarkerGroup.class.getClassLoader(),
			new Class[] { TourismMapMarkerGroup.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		TourismMapMarkerGroupClp clone = new TourismMapMarkerGroupClp();
		...
		clone.setMarkerGroupName(getMarkerGroupName());
		clone.setMarkerGroupInfo(getMarkerGroupInfo());
	...
	public boolean equals(Object obj) {
		...
		TourismMapMarkerGroupClp tourismMapMarkerGroup = null;

		try {
			tourismMapMarkerGroup = (TourismMapMarkerGroupClp)obj;
		}
	...
	private BaseModel<?> _tourismMapMarkerGroupRemoteModel;
}