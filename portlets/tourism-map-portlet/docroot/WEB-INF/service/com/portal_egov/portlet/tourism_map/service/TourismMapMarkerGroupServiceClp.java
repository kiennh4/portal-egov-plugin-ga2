 ...
 * @author HungDX
 */
public class TourismMapMarkerGroupServiceClp
	implements TourismMapMarkerGroupService {
	public TourismMapMarkerGroupServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getJSONmarkerGroups";

		_methodParameterTypes3 = new String[] { "long" };

		_methodName4 = "deleteMarkerGroup";
	...
	public void deleteMarkerGroup(long markerGroupId)
		...
		try {
			...
			if (t instanceof com.portal_egov.portlet.tourism_map.NoSuchTourismMapMarkerGroupException) {
				throw (com.portal_egov.portlet.tourism_map.NoSuchTourismMapMarkerGroupException)t;
			}
