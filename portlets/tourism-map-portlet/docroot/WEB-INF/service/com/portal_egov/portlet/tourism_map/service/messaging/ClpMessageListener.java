...
package com.portal_egov.portlet.tourism_map.service.messaging;

import com.liferay.portal.kernel.messaging.BaseMessageListener;
import com.liferay.portal.kernel.messaging.Message;

import com.portal_egov.portlet.tourism_map.service.ClpSerializer;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			TourismMapMarkerLocalServiceUtil.clearService();

			TourismMapMarkerServiceUtil.clearService();
			TourismMapMarkerGroupLocalServiceUtil.clearService();

			TourismMapMarkerGroupServiceUtil.clearService();
		}
	}
}