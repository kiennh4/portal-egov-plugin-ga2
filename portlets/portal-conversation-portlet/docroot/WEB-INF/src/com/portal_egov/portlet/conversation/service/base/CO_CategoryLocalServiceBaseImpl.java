...
/**
 * The base implementation of the c o_ category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portal_egov.portlet.conversation.service.impl.CO_CategoryLocalServiceImpl}.
 * </p>
 *
 * @author DucDVd
 ...
 * @generated
 */
public abstract class CO_CategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CO_CategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.portal_egov.portlet.conversation.service.CO_CategoryLocalServiceUtil} to access the c o_ category local service.
	 */
	...
	public CO_Category addCO_Category(CO_Category co_Category)
		throws SystemException {
		co_Category.setNew(true);

		return co_CategoryPersistence.update(co_Category, false);
	}
	 ...
	 */
	public CO_Category createCO_Category(long categoryId) {
		return co_CategoryPersistence.create(categoryId);
	}
	...
	public CO_Category deleteCO_Category(long categoryId)
		throws PortalException, SystemException {
		return co_CategoryPersistence.remove(categoryId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CO_Category deleteCO_Category(CO_Category co_Category)
		throws SystemException {
		return co_CategoryPersistence.remove(co_Category);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CO_Category.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return co_CategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return co_CategoryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return co_CategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CO_Category fetchCO_Category(long categoryId)
		throws SystemException {
		return co_CategoryPersistence.fetchByPrimaryKey(categoryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CO_Category getCO_Category(long categoryId)
		throws PortalException, SystemException {
		return co_CategoryPersistence.findByPrimaryKey(categoryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return co_CategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CO_Category> getCO_Categories(int start, int end)
		throws SystemException {
		return co_CategoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCO_CategoriesCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CO_Category updateCO_Category(CO_Category co_Category)
		throws SystemException {
		return updateCO_Category(co_Category, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CO_Category updateCO_Category(CO_Category co_Category, boolean merge)
		throws SystemException {
		co_Category.setNew(false);

		return co_CategoryPersistence.update(co_Category, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.portal_egov.portlet.conversation.model.CO_Category",
			co_CategoryLocalService);
	}
	...
	private CO_CategoryLocalServiceClpInvoker _clpInvoker = new CO_CategoryLocalServiceClpInvoker();
}