...
/**
 * The base implementation of the c o_ conversation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portal_egov.portlet.conversation.service.impl.CO_ConversationLocalServiceImpl}.
 * </p>
 *
 * @author DucDVd
 ...
 * @generated
 */
public abstract class CO_ConversationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CO_ConversationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.portal_egov.portlet.conversation.service.CO_ConversationLocalServiceUtil} to access the c o_ conversation local service.
	 */
	...
	public CO_Conversation addCO_Conversation(CO_Conversation co_Conversation)
		throws SystemException {
		co_Conversation.setNew(true);

		return co_ConversationPersistence.update(co_Conversation, false);
	}
	 ...
	 */
	public CO_Conversation createCO_Conversation(long conversationId) {
		return co_ConversationPersistence.create(conversationId);
	}
	...
	public CO_Conversation deleteCO_Conversation(long conversationId)
		throws PortalException, SystemException {
		return co_ConversationPersistence.remove(conversationId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CO_Conversation deleteCO_Conversation(
		CO_Conversation co_Conversation) throws SystemException {
		return co_ConversationPersistence.remove(co_Conversation);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CO_Conversation.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return co_ConversationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return co_ConversationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CO_Conversation fetchCO_Conversation(long conversationId)
		throws SystemException {
		return co_ConversationPersistence.fetchByPrimaryKey(conversationId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CO_Conversation getCO_Conversation(long conversationId)
		throws PortalException, SystemException {
		return co_ConversationPersistence.findByPrimaryKey(conversationId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return co_ConversationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CO_Conversation> getCO_Conversations(int start, int end)
		throws SystemException {
		return co_ConversationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCO_ConversationsCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CO_Conversation updateCO_Conversation(
		CO_Conversation co_Conversation) throws SystemException {
		return updateCO_Conversation(co_Conversation, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public CO_Conversation updateCO_Conversation(
		CO_Conversation co_Conversation, boolean merge)
		throws SystemException {
		co_Conversation.setNew(false);

		return co_ConversationPersistence.update(co_Conversation, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.portal_egov.portlet.conversation.model.CO_Conversation",
			co_ConversationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = co_ConversationPersistence.getDataSource();
	...
	private CO_ConversationLocalServiceClpInvoker _clpInvoker = new CO_ConversationLocalServiceClpInvoker();
}