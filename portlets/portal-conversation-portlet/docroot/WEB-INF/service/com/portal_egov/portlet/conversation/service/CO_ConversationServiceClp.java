 ...
 * @author DucDVd
 */
public class CO_ConversationServiceClp implements CO_ConversationService {
	public CO_ConversationServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getThreadConversations";
	...
	public com.liferay.portal.kernel.json.JSONObject getThreadConversations(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { groupId, threadId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
