package com.bkav.portal.portlet.complaints.util;
...
import com.bkav.portal.portlet.complaints.ComplaintsAdmin;
...
public class FileAttachmentUtil {
	...
	public static List<DLFileEntry> getComplaintFileAttachments(long complaintId){
		...
		try {
			...
			List<Complaints_DLFileEntries> complaintDLFileList = Complaints_DLFileEntriesLocalServiceUtil.findByComplaintId(complaintId);
	...
	public static long addMultipleFileEntries(ActionRequest actionRequest, ActionResponse actionResponse, String selectedFileName,
		...
		try {
			...
			long folderId = createAttachmentFolder(themeDisplay.getUserId(), themeDisplay.getScopeGroupId(),repositoryId, 0, "KNTCv2", serviceContext);
