...
import com.portal_egov.portlet.inquiry.comparator.InquiryCreateDateComparator;
import com.portal_egov.portlet.inquiry.comparator.InquiryModifiedDateComparator;
import com.portal_egov.portlet.inquiry.model.OnlineInquiry;


public class InquirySearch extends SearchContainer<OnlineInquiry>{
	...
	public InquirySearch(PortletRequest portletRequest,PortletURL iteratorURL){
		...
		iteratorURL.setParameter(InquiryDisplayTerms.INQUIRY_CONTENT, displayTerms.getName());
