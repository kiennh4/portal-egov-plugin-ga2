package com.portal_egov.portlet.ykct.action;
...
public class YKCTViewConfiguration extends DefaultConfigurationAction{
	...
	public String render(PortletConfig portletConfig,
			...
			throws Exception {
		return "/html/ykct/configuration.jsp";
	}
	private static Log _log = LogFactory.getLog(YKCTViewConfiguration.class);
}
