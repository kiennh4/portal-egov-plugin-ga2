package com.bkav.portlet.custom.action;
...
public class ConfigurationActionImpl extends DefaultConfigurationAction {
	...
	public void processAction(PortletConfig portletConfig,
		...
		try {
			 ...
			 * 
			 * boolean showRSSIcon = ParamUtil.getBoolean(actionRequest,
			 * "showRSSIcon", false);
			 * 
			 * boolean showViewMoreAssetURL =
			 * ParamUtil.getBoolean(actionRequest, "showViewMoreAssetURL",
			 * false);
			 * 
			 ...
			 * 
			 * String queryName = ParamUtil.getString(actionRequest,
			 * "queryName", "assetTags");
			 * 
			 * String[] queryValues = StringUtil.split(ParamUtil.getString(
			 * actionRequest, "selectedCategoryIds", StringPool.BLANK));
			 * 
			 * if (Validator.equals(queryName, "assetTags")) {// Truong hop loc
			 * tin // theo Tag queryValues =
			 * StringUtil.split(ParamUtil.getString( actionRequest,
			 ...
			 * "orderByColumn", "publishDate"); String orderByType =
			...
			/*
			 * preferences.setValue("showPublishDate",
			 * String.valueOf(showPublishDate));
			 * preferences.setValue("showRSSIcon", String.valueOf(showRSSIcon));
			 * preferences.setValue("showViewMoreAssetURL",
			 * String.valueOf(showViewMoreAssetURL)); preferences
			 * .setValue("queryContains", String.valueOf(queryContains));
