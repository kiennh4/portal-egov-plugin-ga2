...
/**
 * The utility for the contacts property local service. This utility wraps {@link com.portal_egov.portlet.contacts.service.impl.ContactsPropertyLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.portal_egov.portlet.contacts.service.impl.ContactsPropertyLocalServiceImpl
 * @generated
 */
public class ContactsPropertyLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.portal_egov.portlet.contacts.service.impl.ContactsPropertyLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.portal_egov.portlet.contacts.model.ContactsProperty addContactsProperty(
		com.portal_egov.portlet.contacts.model.ContactsProperty contactsProperty)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addContactsProperty(contactsProperty);
	}
	...
	*/
	public static com.portal_egov.portlet.contacts.model.ContactsProperty createContactsProperty(
		long propertyId) {
		return getService().createContactsProperty(propertyId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.contacts.model.ContactsProperty deleteContactsProperty(
		long propertyId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteContactsProperty(propertyId);
	}
	...
	*/
	public static com.portal_egov.portlet.contacts.model.ContactsProperty deleteContactsProperty(
		com.portal_egov.portlet.contacts.model.ContactsProperty contactsProperty)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteContactsProperty(contactsProperty);
	}
	...
	*/
	...
	public static com.portal_egov.portlet.contacts.model.ContactsProperty fetchContactsProperty(
		long propertyId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchContactsProperty(propertyId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.contacts.model.ContactsProperty getContactsProperty(
		long propertyId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getContactsProperty(propertyId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.portal_egov.portlet.contacts.model.ContactsProperty> getContactsProperties(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getContactsProperties(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getContactsPropertiesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getContactsPropertiesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.portal_egov.portlet.contacts.model.ContactsProperty updateContactsProperty(
		com.portal_egov.portlet.contacts.model.ContactsProperty contactsProperty)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateContactsProperty(contactsProperty);
	}
	...
	*/
	public static com.portal_egov.portlet.contacts.model.ContactsProperty updateContactsProperty(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateContactsProperty(contactsProperty, merge);
	}
	...
	*/
	...
	public static int countByContact(long contactId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().countByContact(contactId);
	}
	...
	public static java.util.List<com.portal_egov.portlet.contacts.model.ContactsProperty> findByContact(
		long contactId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByContact(contactId);
	}

	public static java.util.List<com.portal_egov.portlet.contacts.model.ContactsProperty> findByContact(
		long contactId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByContact(contactId, start, end);
	}
	...
	public static java.util.List<com.portal_egov.portlet.contacts.model.ContactsProperty> findByContactAndPropertyKey(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByContactAndPropertyKey(contactId, propertyKey);
	}
	...
	public static java.util.List<com.portal_egov.portlet.contacts.model.ContactsProperty> findByPropertyKey(
		...
		return getService().findByPropertyKey(groupId, contactId, propertyKey);
	}

	public static com.portal_egov.portlet.contacts.model.ContactsProperty addContactProperty(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addContactProperty(groupId, companyId, userId, userName,
			contactId, propertyKey, propertyValue, propertyType);
	}

	public static com.portal_egov.portlet.contacts.model.ContactsProperty updateContactProperty(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateContactProperty(propertyId, groupId, companyId,
			userId, userName, contactId, propertyKey, propertyValue,
			propertyType);
	}

	public static void deleteContactProperty(long propertyId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.portal_egov.portlet.contacts.NoSuchContactsPropertyException {
		getService().deleteContactProperty(propertyId);
	}
	...
	public static ContactsPropertyLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					ContactsPropertyLocalService.class.getName());

			if (invokableLocalService instanceof ContactsPropertyLocalService) {
				_service = (ContactsPropertyLocalService)invokableLocalService;
			}
			else {
				_service = new ContactsPropertyLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(ContactsPropertyLocalServiceUtil.class,
				"_service");
		}
	 ...
	 * @deprecated
	 */
	public void setService(ContactsPropertyLocalService service) {
	}

	private static ContactsPropertyLocalService _service;
}