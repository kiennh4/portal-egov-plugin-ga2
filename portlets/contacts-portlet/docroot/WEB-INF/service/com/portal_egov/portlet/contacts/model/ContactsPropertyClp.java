 ...
 * @author HungDX
 */
public class ContactsPropertyClp extends BaseModelImpl<ContactsProperty>
	implements ContactsProperty {
	public ContactsPropertyClp() {
	}
	...
	public BaseModel<?> getContactsPropertyRemoteModel() {
		return _contactsPropertyRemoteModel;
	}

	public void setContactsPropertyRemoteModel(
		BaseModel<?> contactsPropertyRemoteModel) {
		_contactsPropertyRemoteModel = contactsPropertyRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			ContactsPropertyLocalServiceUtil.addContactsProperty(this);
		}
		else {
			ContactsPropertyLocalServiceUtil.updateContactsProperty(this);
		}
	}

	@Override
	public ContactsProperty toEscapedModel() {
		return (ContactsProperty)Proxy.newProxyInstance(ContactsProperty.class.getClassLoader(),
			new Class[] { ContactsProperty.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		ContactsPropertyClp clone = new ContactsPropertyClp();
	...
	public boolean equals(Object obj) {
		...
		ContactsPropertyClp contactsProperty = null;

		try {
			contactsProperty = (ContactsPropertyClp)obj;
		}
	...
	private BaseModel<?> _contactsPropertyRemoteModel;
}