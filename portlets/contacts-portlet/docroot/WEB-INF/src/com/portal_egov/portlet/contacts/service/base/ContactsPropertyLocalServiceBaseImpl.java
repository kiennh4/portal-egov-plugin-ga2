...
/**
 * The base implementation of the contacts property local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.portal_egov.portlet.contacts.service.impl.ContactsPropertyLocalServiceImpl}.
 * </p>
 *
 * @author HungDX
 ...
 * @generated
 */
public abstract class ContactsPropertyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ContactsPropertyLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.portal_egov.portlet.contacts.service.ContactsPropertyLocalServiceUtil} to access the contacts property local service.
	 */
	...
	public ContactsProperty addContactsProperty(
		ContactsProperty contactsProperty) throws SystemException {
		contactsProperty.setNew(true);

		return contactsPropertyPersistence.update(contactsProperty, false);
	}
	 ...
	 */
	public ContactsProperty createContactsProperty(long propertyId) {
		return contactsPropertyPersistence.create(propertyId);
	}
	...
	public ContactsProperty deleteContactsProperty(long propertyId)
		throws PortalException, SystemException {
		return contactsPropertyPersistence.remove(propertyId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ContactsProperty deleteContactsProperty(
		ContactsProperty contactsProperty) throws SystemException {
		return contactsPropertyPersistence.remove(contactsProperty);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ContactsProperty.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return contactsPropertyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactsPropertyPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ContactsProperty fetchContactsProperty(long propertyId)
		throws SystemException {
		return contactsPropertyPersistence.fetchByPrimaryKey(propertyId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ContactsProperty getContactsProperty(long propertyId)
		throws PortalException, SystemException {
		return contactsPropertyPersistence.findByPrimaryKey(propertyId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return contactsPropertyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ContactsProperty> getContactsProperties(int start, int end)
		throws SystemException {
		return contactsPropertyPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getContactsPropertiesCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ContactsProperty updateContactsProperty(
		ContactsProperty contactsProperty) throws SystemException {
		return updateContactsProperty(contactsProperty, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public ContactsProperty updateContactsProperty(
		ContactsProperty contactsProperty, boolean merge)
		throws SystemException {
		contactsProperty.setNew(false);

		return contactsPropertyPersistence.update(contactsProperty, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.portal_egov.portlet.contacts.model.ContactsProperty",
			contactsPropertyLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = contactsPropertyPersistence.getDataSource();
	...
	private ContactsPropertyLocalServiceClpInvoker _clpInvoker = new ContactsPropertyLocalServiceClpInvoker();
}