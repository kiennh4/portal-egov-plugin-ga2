...
/**
 * The base implementation of the legal f a q entry local service.
 *
 * <p>
...
public abstract class LegalFAQEntryLocalServiceBaseImpl
	...
	public LegalFAQEntry addLegalFAQEntry(LegalFAQEntry legalFAQEntry)
		...
		return legalFAQEntryPersistence.update(legalFAQEntry, false);
	}
	...
	public LegalFAQEntry updateLegalFAQEntry(LegalFAQEntry legalFAQEntry)
		throws SystemException {
		return updateLegalFAQEntry(legalFAQEntry, true);
	}
	...
	public LegalFAQEntry updateLegalFAQEntry(LegalFAQEntry legalFAQEntry,
		...
		return legalFAQEntryPersistence.update(legalFAQEntry, merge);
	}
