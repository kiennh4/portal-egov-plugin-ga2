...
import com.bkav.portal.portlet.contentsharing.ContentSharingAdmin;
...
public class TTHCConstants {
	...
	//Ten folder chua file dinh kem cua thu tuc khi upload len server
	public static final String DEFAULT_TTHC_FILE_ATTACHMENT_TEMP_FOLDER_NAME = ContentSharingAdmin.class.getName();
