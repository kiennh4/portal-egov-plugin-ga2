		...
		<div class="global-search-wrapper">
			<form
				...
				<input name="p_p_id" type="hidden" value="3"><input
					...
					name="_3_groupId">
					<option value="0" selected="">moi thu</option>
					<option value="19">trang thong tin nay</option>
				</select> <input align="absmiddle" border="0"
					src="/portal-binh-dinh-theme/images/common/search.png"
					title="Tim kiem" type="image">
