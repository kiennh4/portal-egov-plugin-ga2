...
public class AudioPlayerConfig extends DefaultConfigurationAction {
	@Override
	public void processAction(PortletConfig portletConfig,
		...
		try {
			...
			//Kieu hien thi
			String displayStyle = ParamUtil.getString(actionRequest, "displayStyle","small-style");
			
			preferences.setValue("display-style", displayStyle);
			
			String defaultAlbum = ParamUtil.getString(actionRequest, "defaultAlbum","");
			
			preferences.setValue("default-album", defaultAlbum);
	...
	private static Log _log = LogFactory.getLog(AudioPlayerConfig.class);
}
