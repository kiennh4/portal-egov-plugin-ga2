 ...
 * @author anhbdb
 */
public class AudioAlbumLocalServiceClp implements AudioAlbumLocalService {
	public AudioAlbumLocalServiceClp(
		...
		_methodName22 = "getAudioAlbumCounter";

		_methodParameterTypes22 = new String[] { "long" };

		_methodName23 = "addAudioAlbum";
		...
		_methodName24 = "updateAudioAlbum";

		_methodParameterTypes24 = new String[] {
				"java.lang.String", "java.lang.String", "long", "long", "long"
			};

		_methodName25 = "updateAlbumView";
	...
	public com.bkav.portal.portlet.audioplayer.model.AudioAlbum addAudioAlbum(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(audioAlbum) });
		}
		catch (Throwable t) {
		...
		return (com.bkav.portal.portlet.audioplayer.model.AudioAlbum)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.bkav.portal.portlet.audioplayer.model.AudioAlbum fetchAudioAlbum(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { albumId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.bkav.portal.portlet.audioplayer.model.AudioAlbum> getAudioAlbums(
		...
		return (java.util.List<com.bkav.portal.portlet.audioplayer.model.AudioAlbum>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.bkav.portal.portlet.audioplayer.model.AudioAlbum updateAudioAlbum(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(audioAlbum), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.bkav.portal.portlet.audioplayer.model.AudioAlbum getAudioAlbumCounter(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName22,
					_methodParameterTypes22, new Object[] { albumId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.bkav.portal.portlet.audioplayer.model.AudioAlbum addAudioAlbum(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					ClpSerializer.translateInput(albumName),
						
					ClpSerializer.translateInput(albumInfo),
	...
	public com.bkav.portal.portlet.audioplayer.model.AudioAlbum updateAlbumView(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName25,
					_methodParameterTypes25, new Object[] { albumId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
